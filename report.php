...
<body>
  ...
  <aside class="sidebar sidebar-maxwidth sidebar-minwidth">
    ...
    <nav>
	    <ul>
	      <a href="index.php"><li>Today</li></a>
	      <li>Reports</li>
	      <li>Budget</li>
	      <li>Export/Import</li>
	      <li>Setting</li>
		...
		<section id="overviewWrapper" class="ov-wrapper">
			<section id="ovCashflowDiv" class="ov-section ov-cashflow-section">
				...
				<header class="ov-cashflow-header">
					...
					<section class="ov-header-section">
						<section class="ov-header-section-left col-6 col-m-6">
							<span>Sort by</span>
						...
						<section id="ovCashflowViewModeDiv" class="ov-header-section-right col-6 col-m-6">
							<span>View mode:</span>
